<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=soft&color=0:1a1b27,100:7aa2f7&height=240&section=header&text=Ausaf%20Ali&fontSize=80&animation=fadeIn&fontColor=79ffad" />
</p>
...
### 🧬 Digital Identity
*"Every line of code leaves a fingerprint. I build the tools that find them."*
...
<table align="center">
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>🔭 <b>Focus:</b> Architecting data-driven automation & forensic C++ engines.</li>
        <li>👯 <b>Open To:</b> ML research, API pipeline scaling, and algorithmic optimization.</li>
        <li>⚡ <b>Mantra:</b> If it can be automated, it should be. If it's data, it should be analyzed.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h4>🧠 Knowledge Graph</h4>
      <ul>
        <li>🌱 <b>Currently Mastering:</b> Scalable Model Deployment & Bayesian Statistics.</li>
        <li>💬 <b>Consult Me On:</b> Forensic Stylometry, Python Workflows, & n8n Logic.</li>
        <li>🤝 <b>Seeking:</b> Mentorship in High-Performance Computing (HPC).</li>
      </ul>
    </td>
  </tr>
</table>
...
| **Core Engineering** | **Data & Automation** | **Environments** |
| :--- | :--- | :--- |
| ![C++](https://img.shields.io/badge/C++-00599C?style=flat-square&logo=c%2B%2B&logoColor=white) | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | ![n8n](https://img.shields.io/badge/n8n-FF6D5A?style=flat-square&logo=n8n&logoColor=white) |
| ![C](https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=c&logoColor=black) | ![Pandas](https://img.shields.io/badge/Pandas-150458?style=flat-square&logo=pandas&logoColor=white) | ![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black) |
| ![OOP](https://img.shields.io/badge/OOP-Systems-79ffad?style=flat-square) | ![SQL](https://img.shields.io/badge/SQL-4479A1?style=flat-square&logo=postgresql&logoColor=white) | ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) |
...
<p align="center">
  <img src="https://visitcount.itsvg.in/api?id=iausafali&icon=5&color=00D4FF" />
</p>
